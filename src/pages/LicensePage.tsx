    ...
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      ...
      <div className="prose dark:prose-invert prose-lg max-w-none">
        ...
        <p>
          ...
          <a href="https://crxanode.me" target="_blank" rel="noopener noreferrer">
            crxanode.me
          </a>{" "}
        ...
        <ul>
          ...
          <li>
            ...
            attribution: <em>“Source: CRXANODE — crxanode.me”</em>.
          </li>
          <li>
        ...
        <p>
          ...
          <a href="mailto:admin@CRXANODE.me">admin@crxanode.me</a> to discuss commercial
          partnerships.
        </p>
        ...
        <p>
          ...
          be available at{" "}
          <a href="https://docs.crxanode.me/license" target="_blank" rel="noopener noreferrer">
            docs.crxanode.me/license
          </a>.
        </p>
        ...
        <p>
          ...
          <a href="mailto:admin@crxanode.me">admin@crxanode.me</a>
        </p>
