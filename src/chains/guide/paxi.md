...
```bash
curl -Ls https://cdn.crxanode.me/paxi/genesis.json > ~/go/bin/paxi/config/genesis.json
curl -Ls https://cdn.crxanode.me/paxi/addrbook.json > ~/go/bin/paxi/config/addrbook.json
```
...
curl -L https://cdn.crxanode.me/paxi/paxi-latest.tar.lz4 | lz4 -dc - | tar -xf - -C ~/go/bin/paxi
